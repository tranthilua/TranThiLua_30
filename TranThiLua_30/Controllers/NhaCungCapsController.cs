...
using TranThiLua_30.Models;

namespace TranThiLua_30.Controllers
{
    public class NhaCungCapsController : Controller
    {
        ...
        {
            return View(db.NhaCungCapss.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            NhaCungCap nhaCungCap = db.NhaCungCapss.Find(id);
            if (nhaCungCap == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Create([Bind(Include = "MaNhaCungCap,TenNhaCungCap")] NhaCungCap nhaCungCap)
        {
            ...
            {
                db.NhaCungCapss.Add(nhaCungCap);
                db.SaveChanges();
        ...
        {
            NhaCungCap nhaCungCap = db.NhaCungCapss.Find(id);
            db.NhaCungCapss.Remove(nhaCungCap);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
